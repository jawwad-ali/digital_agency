        ...
        <div className='bg-[#051740] py-20'>
            ...
            <div className='w-full mt-14'>
                <div className='flex xl:flex-row flex-col'>
                    ...
                    <div className='flex flex-wrap flex-col xl:w-2/4 lg:w-full lg:ml-8 xl:ml-20 w-[90%] ml-10'>
                        <div className='xl:border-b-2 text-slate-400 pb-6 -ml-6 md:mx-8'>
                            <h1 className='font-[Light] md:text-[64px] text-[50px] font-black text-[#ACE3E1] xl:leading-[88px]'>Closing Africas' Data Gap</h1>
                            <p className='font-[poppins] text-lg lg:text-3xl lg:leading-[63px] text-slate-400  leading-[50px]'>
                        ...
                        <div className='font-[poppins] lg:mt-10 md:w-[95%] lg:w-[90%] w-full -mx-6  md:mx-8'>
                            <p className='font-bold xl:text-xl md:text-xl text-md leading-[29px] text-[#ACE3E1] text-base'>
                        ...
                        <div className='mt-10 flex xl:flex-row flex-col mr-5  md:ml-10 lg:mx-8'>
                            ...
                            <button className='rounded-[30px] w-full md:w-[42%] lg:w-[29%] xl:w-[50%] xl:ml-10 mt-5 xl:mt-0 xl:px-12 xl:py-6 px-2 py-4 font-[Light] bg-[#31B9B5] text-white text-center leading-[25px] text-xl font-medium'>
                                claim your space
                            </button>
                        </div>
                    </div>
